...
var FileInputFileSystem = class _FileInputFileSystem extends VirtualFileSystem {
  constructor(files) {
    super();
    this.files = files;
  }
  static {
    __name(this, "FileInputFileSystem");
  }
  static fromFileList(fileList) {
    return new _FileInputFileSystem(Array.from(fileList));
  }
  *list() {
...
var ProxCanvasShellElement = class extends KCUIElement {
  constructor() {
    super();
  ...
  static {
    __name(this, "ProxCanvasShellElement");
  }
  static {
    this.styles = [
      ...KCUIElement.styles,
  ...
  initialContentCallback() {
    ...
    this.file_input.addEventListener("change", async (e) => {
      const files = e.target.files;
      if (!files || files.length === 0) {
        return;
      }
      const vfs = FileInputFileSystem.fromFileList(files);
      await this.setup_project(vfs);
    });
  }
            ...
            <kc-ui-app>
                <section class="overlay">
                    ...
                    <input
                        ...
                        type="file"
                        multiple
                        accept=".kicad_sch,.kicad_pcb,.kicad_pro,.sch,.brd,.pro"
                        style="display: none" />
                    <button
                        type="button"
                        onclick="this.previousElementSibling.click()"
                        style="padding: 12px 24px; font-size: 16px; background: #0066cc; color: white; border: none; border-radius: 6px; cursor: pointer; margin: 16px 0;">
                        Browse Files
                    </button>
...
__decorateClass([
  attribute({ type: Boolean })
], ProxCanvasShellElement.prototype, "loading", 2);
__decorateClass([
  attribute({ type: Boolean })
], ProxCanvasShellElement.prototype, "loaded", 2);
__decorateClass([
  attribute({ type: String })
], ProxCanvasShellElement.prototype, "src", 2);
__decorateClass([
  query(`input[name="files"]`, true)
], ProxCanvasShellElement.prototype, "file_input", 2);
window.customElements.define("kc-proxcanvas-shell", ProxCanvasShellElement);

// src/kicanvas/elements/kicanvas-embed.ts
var ProxCanvasEmbedElement = class extends KCUIElement {
  constructor() {
    super();
    this.#project = new Project();
  ...
  static {
    __name(this, "ProxCanvasEmbedElement");
  }
  static {
    this.styles = [
      ...KCUIElement.styles,
      ...
      css`
            :host {
                ...
                color: var(--fg);
                font-family: "Arista Pro", "Nunito", ui-rounded, "Hiragino Maru Gothic ProN",
...
__decorateClass([
  attribute({ type: String })
], ProxCanvasEmbedElement.prototype, "src", 2);
__decorateClass([
  attribute({ type: Boolean })
], ProxCanvasEmbedElement.prototype, "loading", 2);
__decorateClass([
  attribute({ type: Boolean })
], ProxCanvasEmbedElement.prototype, "loaded", 2);
__decorateClass([
  attribute({ type: String })
], ProxCanvasEmbedElement.prototype, "controls", 2);
__decorateClass([
  attribute({ type: String })
], ProxCanvasEmbedElement.prototype, "controlslist", 2);
__decorateClass([
  attribute({ type: String })
], ProxCanvasEmbedElement.prototype, "theme", 2);
__decorateClass([
  attribute({ type: String })
], ProxCanvasEmbedElement.prototype, "zoom", 2);
window.customElements.define("proxcanvas-embed", ProxCanvasEmbedElement);
var ProxCanvasSourceElement = class extends CustomElement {
  constructor() {
    super();
  ...
  static {
    __name(this, "ProxCanvasSourceElement");
  }
};
__decorateClass([
  attribute({ type: String })
], ProxCanvasSourceElement.prototype, "src", 2);
window.customElements.define("proxcanvas-source", ProxCanvasSourceElement);
...
//# sourceMappingURL=proxcanvas.js.map
